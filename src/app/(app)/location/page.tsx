...
const Location = () => {
    ...
    useEffect(() => {
        ...
        const id = governorates.find(
            (g) => g.name_ar === formData.governorate
        )?.id;
        axios
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-purple-100 to-orange-100 flex items-center justify-center py-10 px-4 overflow-hidden">
            <SmartNavbar />
            <Container>
                <form
                    className="bg-white shadow-2xl rounded-3xl md:p-8 p-5  w-full max-w-md space-y-6 border border-purple-100 mt-20"
